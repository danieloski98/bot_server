    ...
    return (
        <div className="w-72 h-auto  rounded-lg bg-gray-100 p-5 flex flex-col">
                    ...
                    <div className="flex w-full justify-between mt-5">
                        <button className="bg-green-700 text-xs flex-1 p-1 mx-2 text-white rounded">Approve</button>
                        <button className="bg-white text-xs flex-1 p-1 mx-2 text-green-700 border-2 border-green-700 rounded">Decline</button>
                    </div>
        </div>
    )
}
